...
## 安装
推荐下载 乌龟 svn 客户端
![在这里插入图片描述](./image/image-2026-04-03-1.png)
安装完成后，比如在我的项目在qiandaun1中，我右键就可以看到如下：

![在这里插入图片描述](./image/image-2026-04-03-2.png)
...
![在这里插入图片描述](./image/image-2026-04-03-3.png)


其中 URL 我可以在 SVN 服务器获取到，这一步的目的主要是为了绑定本地和 SVN 服务器的目录，然后就会变成下面这样

![在这里插入图片描述](./image/image-2026-04-03-4.png)
...
![在这里插入图片描述](./image/image-2026-04-03-5.png)
...
![在这里插入图片描述](./image/image-2026-04-03-7.png)
...
![在这里插入图片描述](./image/image-2026-04-03-8.png)
