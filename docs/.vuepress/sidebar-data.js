...
const sidebarData = {
  ...
  "_distributed": [
    ...
    "/_posts/_distributed/关于分布式系统 RPC 中高可用功能的实现.md",
  ...
  "_ai": [
    ...
    "/_posts/_ai/vibe coding 最佳实践.md",
  ...
  "_project": [
    "/_posts/_project/面试刷题网——技术方案.md",
    "/_posts/_project/影视资源聚合站——技术方案.md"
  ],
  "_question": [
  ...
  "_other": [
    ...
    "/_posts/_other/创业全链路SOP：从灵光一现到系统化增长的实战指南.md",
    "/_posts/_other/观罗翔讲刑法随笔.md",
    "/_posts/_other/价格和价值.md",
    "/_posts/_other/梅花易数学习笔记.md",
    "/_posts/_other/压力管理.md"
  ]
}
