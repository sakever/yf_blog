...
- 使用**线程池**来接受该类型请求，线程池设置了最大线程数，就算接受了过多的请求，也不会占用太多机器线程资源
...
![image-2026-01-31-21-06-17.png](./image/image-2026-01-31-21-06-17.png)
...
![image-2026-01-31-21-06-32.png](./image/image-2026-01-31-21-06-32.png)
## 常用的框架
...
![image-2026-01-31-21-06-45.png](./image/image-2026-01-31-21-06-45.png)
此时服务提供方、服务消费方紧耦合。适合我们作为服务提供者的场景

二、抽取方式：将 Feign 的 Client 抽取为独立模块，并且把接口有关的 POJO、默认的 Feign 配置都放到这个模块中，提供给所有消费者使用
![image-2026-01-31-21-06-59.png](./image/image-2026-01-31-21-06-59.png)
### Ribbon
